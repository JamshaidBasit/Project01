...
def clear_results_collection():
    ...
    try:
        ...
        if mongo_client:
            mongo_client.close()
            # print("MongoDB connection closed after clearing.") # Optional: keep print for clarity
...
def save_results_to_mongo(report_data: Dict, result_with_review: Dict):
    ...
    Args:
        report_data (Dict): Contains information about the text chunk (e.g., ID, page, text, metadata).
    ...
    try:
        ...
        if mongo_client:
            mongo_client.close()
            # print("MongoDB results connection closed.") # Optional: keep print for clarity